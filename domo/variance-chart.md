...
Use the Chart Properties tool to customize the appearance of a variance chart. See [Properties for tables](https://domo-support.domo.com/s/article/360042925374?language=en_US) for more information.
