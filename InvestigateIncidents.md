...
In the **Overview** tab, you can edit summary field values, including any values for custom fields you created, by selecting the edit icon ( [edit icon](https://docs.splunk.com/images/5/52/PencilEdit.png) =50x50 ). After you edit the field values, select **Save**.
