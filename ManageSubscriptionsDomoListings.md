...
On the Appstore, you can subscribe to listings with a monthly payment. After you make the initial subscription payment, anyone in your organization's Domo instance can install and use the listing. You also have the flexibility to cancel subscriptions at any time.
