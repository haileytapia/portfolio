...
Some Appstore listings require a monthly payment. After you make the initial payment for a subscription listing, anyone in your company's Domo instance can use and install the subscription listing. Payments are processed through Stripe, and you have the flexibility to cancel subscriptions at any time.
