...
4. (Optional) To create an additional field, select **+ Summary field**, and then follow the instructions in the previous step.
5. Select **Submit**.
