...
Recurring events are events that occur on a regular basis, such as weekly meetings or monthly check-ins, and require multiple instances of the same event. You can use the calendar and scheduling component of [Outlook on the web](https://outlook.live.com/owa/) to schedule recurring events.

## Create a recurring event
To create a recurring event in Outlook on the web, follow these steps:
