...
The circular Sankey chart is a type of Sankey chart that allows you to visualize recursive data, or data that returns to the same point from which it started.
