...
The circular Sankey chart is a type of Sankey chart that allows you to visualize recursive data, which is data that returns to the same point from which it started.
